...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("CryptoYen Core cryptoyen_modern-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cryptoyen_modern-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptoyen_modern transaction") + "\n" +
                               "  cryptoyen_modern-tx [options] -create [commands]   " + _("Create hex-encoded cryptoyen_modern transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cryptoyen_modern transaction
