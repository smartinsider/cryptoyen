...
<context>
    ...
    <message>
        <source>To use cryptoyen_modernd, or the -server option to cryptoyen_modern-qt, you must set an rpcpassword in the configuration file:
%s
It is recommended you use the following random password:
rpcuser=cryptoyen_modernrpc
rpcpassword=%s
...
for example: alertnotify=echo %%s | mail -s "YEN Alert" admin@foo.com
        ...
        <translation>To use cryptoyen_modernd, or the -server option to cryptoyen_modern-qt, you must set an rpcpassword in the configuration file:
%s
It is recommended you use the following random password:
rpcuser=cryptoyen_modernrpc
rpcpassword=%s
...
for example: alertnotify=echo %%s | mail -s "YEN Alert" admin@foo.com
    ...
    <message>
        ...
        <translation>Initialization sanity check failed. CryptoYen Coin is shutting down.</translation>
    </message>
    <message>
