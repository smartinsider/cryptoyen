...
#define URI_SCHEME "cryptoyen_modern"
...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a YEN address (e.g. %1)").arg("HaMa9ev76EeDAxuWWc8cizUBF4G3jis1dx"));
...
{
    // Convert cryptoyen_modern:// to cryptoyen_modern:
    //
    //    Cannot handle this later, because cryptoyen_modern:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open cryptoyen_modern.conf with the associated application */
...
{
    return GetAutostartDir() / "cryptoyen_modern.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a cryptoyen_modern.desktop file to the autostart directory:
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the cryptoyen_modern app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add cryptoyen_modern app to startup item list
