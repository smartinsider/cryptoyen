...
// Wallet
    ...
    if (settings.contains("nAnonymizeCryptoYenAmount"))
        SoftSetArg("-anonymizecryptoyen_modernamount", settings.value("nAnonymizeCryptoYenAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in cryptoyen_modern.cpp during shotdown to also remove the window positions
