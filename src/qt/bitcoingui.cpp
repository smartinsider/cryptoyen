                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CryptoYen Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cryptoyen_modern: URIs)"));
    ...
    governanceAction = new QAction(QIcon(":/icons/governance"), tr("&Coin info"), this);
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CryptoYen Coin"), this);
    aboutAction->setStatusTip(tr("Show information about CryptoYen Coin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show The CryptoYen Core help message to get a list with possible YEN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CryptoYen Coin client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CryptoYen network", "", count));
}
...
{
    QString strTitle = tr("CryptoYen Coin"); // default title
