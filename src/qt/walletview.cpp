...
{   
    ...
    labelOverviewHeaderRight->setMinimumSize(QSize(60, 60));
    labelOverviewHeaderRight->setMaximumSize(QSize(60, 60));
    ...
    horizontalLayout_Header->addWidget(pushBuyCoin);
