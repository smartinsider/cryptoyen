...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("CryptoYen Coin"),
     ...
     * override -datadir in the cryptoyen_modern.conf file in the default data directory
     * (to be consistent with cryptoyen_modernd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
