...
static const struct {
    ...
    {"test", QAPP_APP_NAME_TESTNET, ":/icons/bitcoin", QT_TRANSLATE_NOOP("SplashScreen", "[testnet]"), ":/images/splash"},
    {"regtest", QAPP_APP_NAME_TESTNET, ":/icons/bitcoin", "[regtest]", ":/images/splash"}};
