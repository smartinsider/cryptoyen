...
// Copyright (c) 2018-2019 The CryptoYen developers
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (cryptoyen_modern.conf).");
            QMessageBox::warning(this, "CryptoYen Coin Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
