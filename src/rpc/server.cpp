...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop CryptoYen server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "CryptoYen server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* YEN features */
        {"cryptoyen_modern", "masternode", &masternode, true, true, false},
        {"cryptoyen_modern", "listmasternodes", &listmasternodes, true, true, false},
        {"cryptoyen_modern", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cryptoyen_modern", "masternodeconnect", &masternodeconnect, true, true, false},
//        {"cryptoyen_modern", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
//        {"cryptoyen_modern", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
//        {"cryptoyen_modern", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cryptoyen_modern", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cryptoyen_modern", "masternodedebug", &masternodedebug, true, true, false},
        {"cryptoyen_modern", "startmasternode", &startmasternode, true, true, false},
        {"cryptoyen_modern", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cryptoyen_modern", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cryptoyen_modern", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cryptoyen_modern", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cryptoyen_modern", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cryptoyen_modern", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cryptoyen_modern", "mnsync", &mnsync, true, true, false},
        {"cryptoyen_modern", "spork", &spork, true, true, false},
        {"cryptoyen_modern", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> cryptoyen_modern-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17172/\n";
}
