...
// Copyright (c) 2018-2020 The CryptoYen developers
...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total cryptoyen_modern balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in cryptoyen_modern/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in cryptoyen_modern/kb\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"cryptoyen_modernaddress\"\n"
            "\nReturn information about the given cryptoyen_modern address.\n"

            "\nArguments:\n"
            "1. \"cryptoyen_modernaddress\"     (string, required) The cryptoyen_modern address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"cryptoyen_modernaddress\", (string) The cryptoyen_modern address validated\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are cryptoyen_modern addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) cryptoyen_modern address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"cryptoyen_modernaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"cryptoyen_modernaddress\"  (string, required) The cryptoyen_modern address to use for the signature.\n"
