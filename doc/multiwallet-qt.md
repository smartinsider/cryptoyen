...
In order to support loading of multiple wallets in cryptoyen_modern-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cryptoyen_modern.cpp.
...
Changes to cryptoyen_modern.cpp
----------------------
cryptoyen_modern.cpp is the entry point into cryptoyen_modern-qt, and as such, will require some minor modifications to provide hooks for
