...
to cryptoyen_modern-crypto.com.
...
- [Building YEN](#building-cryptoyen_modern)
...
Clone the git repositories for cryptoyen_modern and gitian and then checkout the cryptoyen_modern version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/cryptoyen_modern-crypto/cryptoyen_modern.git
cd cryptoyen_modern
...
Follow the instructions in [doc/release-process.md](release-process.md) in the cryptoyen_modern repository
...
gitian builds' in [doc/release-process.md](release-process.md) in the cryptoyen_modern repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/cryptoyen_modern/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/cryptoyen_modern-crypto/cryptoyen_modern
...
For example:
```bash
URL=https://github.com/crowning-/cryptoyen_modern.git
COMMIT=b616fb8ef0d49a919b72b0388b091aaec5849b96
./bin/gbuild --commit cryptoyen_modern=${COMMIT} --url cryptoyen_modern=${URL} ../cryptoyen_modern/contrib/gitian-descriptors/gitian-linux.yml
./bin/gbuild --commit cryptoyen_modern=${COMMIT} --url cryptoyen_modern=${URL} ../cryptoyen_modern/contrib/gitian-descriptors/gitian-win.yml
./bin/gbuild --commit cryptoyen_modern=${COMMIT} --url cryptoyen_modern=${URL} ../cryptoyen_modern/contrib/gitian-descriptors/gitian-osx.yml
```
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/cryptoyen_modern-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/cryptoyen_modern-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/cryptoyen_modern-build.assert
```
...
[cryptoyen_modern/gitian.sigs](https://github.com/cryptoyen_modern-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
