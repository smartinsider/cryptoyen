Contributing to CryptoYen Coin
============================

The CryptoYen Core project operates an open contributor model where anyone is
...
The following applies to code changes to The CryptoYen Core project, and is not to be
confused with overall YEN Network Protocol consensus changes.

Whether a pull request is merged into CryptoYen Coin rests with the project merge
...
The project leader is the release manager for each CryptoYen Coin release.
